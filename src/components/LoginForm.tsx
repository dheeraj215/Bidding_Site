...
import { Mail, Lock, Eye, EyeOff, User, Phone, Building2, Shield, Users } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">Sign in to your bidding account</p>
        </div>
        ...
        <div className="mt-6 space-y-4">
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-sm font-medium text-blue-900">Admin Login</h4>
                <p className="text-sm text-blue-700 mt-1">
                  Email: admin@biddingplatform.com<br />
                  Password: admin123
                </p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-sm font-medium text-green-900">User Login</h4>
